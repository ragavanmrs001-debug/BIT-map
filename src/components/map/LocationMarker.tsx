...
export function LocationMarkerButton() {
  ...
  return (
    <button
      ...
      className={`fixed right-5 bottom-[210px] z-[140] w-11 h-11 rounded-xl backdrop-blur-md border shadow-lg flex items-center justify-center font-bold text-lg transition-all ${
        isLocating
